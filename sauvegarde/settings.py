...
SECRET_KEY = 'django-insecure-8clr&lctn=042n%gnotu5j%j+5fvf5a!ym%p!&x5*^&c7hb%_h'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1','46.101.108.56','bilalboudjidjportfolio.site']

CSRF_TRUSTED_ORIGINS = ['https://*.bilalboudjidjportfolio.site']
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware', # LocaleMiddleware
